#ifndef MODEL_STHANDPOSE_H_
#define MODEL_STHANDPOSE_H_

#include <stdint.h>
#include "microvsa_config.h"

#define MICROVSA_MODEL_FHV_DIMENSION_BIT 192
#if MICROVSA_IMPL_WORDSIZE == 8
#define MICROVSA_MODEL_FHV_DIMENSION_WORD 24
#elif MICROVSA_IMPL_WORDSIZE == 16
#define MICROVSA_MODEL_FHV_DIMENSION_WORD 12
#elif MICROVSA_IMPL_WORDSIZE == 32
#define MICROVSA_MODEL_FHV_DIMENSION_WORD 6
#else
# error Unsupport look up configuration
#endif
#define MICROVSA_MODEL_NUM_CLASS 8
#define MICROVSA_MODEL_NUM_FEATURE 128
