...
#define MODEL_NAME 1    // 0 = PTB ECG, 1 = HAR, 2 = Hey Snapdragon, 3 = FSDD
...
#define LDC_IMPLEMENTATION_NUMBIT 16
#define LDC_IMPLEMENTATION_LUTBIT 16
#define LDC_MODEL_DTYPE uint16_t
#define LDC_MODEL_ACC_DTYPE int16_t
#define LDC_MODEL_LUT_RET_DTYPE int16_t	// int8_t on 8-bit MCU, LDC_MODEL_ACC_DTYPE on 16/32-bit MCU
...
#define LDC_MAX_NUM_CLASS 6
#define LDC_MAX_FHV_DIM 4
