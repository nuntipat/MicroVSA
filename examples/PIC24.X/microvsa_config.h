...
#define MICROVSA_IMPL_WORDSIZE 16           // 8 for 8-bit MCU, 16 for 16-bit MCU and 32 for 32-bit MCU

#define MICROVSA_TMP_DTYPE uint16_t         // datatype for all temporary variables. uint8_t for 8-bit MCU, uint16_t for 16-bit MCU or uint32_t for 32-bit MCU
#define MICROVSA_ACC_DTYPE int16_t          // datatype for all accumulators. int16_t for 8/16-bit MCU or int32_t for 32-bit MCU
...
#define TIMER_COUNTER_DTYPE uint16_t
