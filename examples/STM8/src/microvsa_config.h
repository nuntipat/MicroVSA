...
#define MICROVSA_IMPL_WORDSIZE 8           // 8 for 8-bit MCU, 16 for 16-bit MCU and 32 for 32-bit MCU

#define MICROVSA_TMP_DTYPE uint8_t         // datatype for all temporary variables. uint8_t for 8-bit MCU, uint16_t for 16-bit MCU or uint32_t for 32-bit MCU
