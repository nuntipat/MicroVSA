...
#define LDC_IMPLEMENTATION_LUTBIT 32
#define LDC_MODEL_DTYPE uint32_t
#define LDC_MODEL_ACC_DTYPE int32_t
#define LDC_MODEL_LUT_RET_DTYPE int32_t	// int8_t on 8-bit MCU, LDC_MODEL_ACC_DTYPE on 16/32-bit MCU
