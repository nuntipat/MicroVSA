...
if __name__ == '__main__':
    ...
    assert_file_already_existed([f'{project_dir}/src/model.h', f'{project_dir}/src/model.c'])
    ...
    os.symlink(f'../../../model/model_{args.model}_{args.df}sb.h', f'{project_dir}/src/model.h')
    os.symlink(f'../../../model/model_{args.model}_{args.df}sb.c', f'{project_dir}/src/model.c')
    results = []
    ...
    os.remove(f'{project_dir}/src/model.h')
    os.remove(f'{project_dir}/src/model.c')

    # test binary LDC
    print ('Testing binary LDC...')
    os.symlink(f'../../../model/model_{args.model}_{args.df}s.h', f'{project_dir}/src/model.h')
    os.symlink(f'../../../model/model_{args.model}_{args.df}s.c', f'{project_dir}/src/model.c')
    if args.word_size == 8:
    ...
    os.symlink(f'../../../model/model_{args.model}_{args.df}.h', f'{project_dir}/src/model.h')
    os.symlink(f'../../../model/model_{args.model}_{args.df}.c', f'{project_dir}/src/model.c')
    if args.word_size == 8:
