...
#define MODEL_NAME 3    // 0 = PTB ECG, 1 = HAR, 2 = Hey Snapdragon, 3 = FSDD
...
#define LDC_IMPLEMENTATION_NUMBIT 8
#define LDC_IMPLEMENTATION_LUTBIT 8
#define LDC_MODEL_DTYPE uint8_t
